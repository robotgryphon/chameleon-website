...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cs_shell_html__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cs_shell_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__cs_shell_html__);
...
const RegisterHtmlTemplate = __webpack_require__(0);
RegisterHtmlTemplate.register(" <dom-module id=\"cs-shell\"> <template> <cs-schedule></cs-schedule> Butts? </template> </dom-module>");
...
const RegisterHtmlTemplate = __webpack_require__(0);
RegisterHtmlTemplate.register(" <dom-module id=\"cs-splash\"> <template> <style type=\"text/css\">:host{display:block;width:100%;height:100%;position:relative;font-style:normal;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif}header{height:60vh;width:100%;position:relative;display:flex;flex-direction:column;background-color:#228b22}cs-top-navigation{position:relative;width:100%;z-index:30;padding-top:1em}cs-banner{position:absolute;height:inherit;top:0;left:0;z-index:10}header div#overlay{display:flex;flex-direction:column;width:fit-content;align-items:center;margin-top:1.6em;margin-left:1em;z-index:25}div#overlay div#contact-wrapper{box-sizing:border-box;width:fit-content}div#tel-wrap{background-color:rgba(16,48,115,.7)!important;color:#fff}div#contact-wrapper>div{background-color:rgba(30,150,30,.5);padding:.4em .8em;color:#eee;box-sizing:border-box;border-radius:4px;align-self:center;text-align:center;margin-bottom:.2em}div#contact-wrapper span{font-size:.7em;text-transform:uppercase;letter-spacing:.05em}div#message{margin-top:1em;text-align:center;font-weight:700;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;color:#fff;font-size:20pt;font-variant-caps:all-petite-caps}address#telephone{font-size:1.2em;font-style:normal;font-weight:700}footer{box-sizing:border-box;height:40vh;background:#228b22 url(/media/wood.jpg) repeat center center;background-size:cover}</style> <header> <cs-banner></cs-banner> <div id=\"overlay\"> <div id=\"banner-logo\"> <img src=\"/media/logo-md-border.png\" alt=\"Chameleon Services logo\" width=\"240\"> </div> <div id=\"contact-wrapper\"> <div id=\"tel-wrap\"> <address id=\"telephone\">(941) 893.9977</address> </div> </div> </div> </header> <footer> <cs-top-navigation></cs-top-navigation> <div id=\"header-spacer\" style=\"flex-grow:1\"></div> <div id=\"message\"> <p>Please excuse us while we work to improve our site. <br> More information coming soon!</p> </div> </footer> </template> </dom-module>");

class ChameleonSplash extends Polymer.Element {
    static get is() {
        return 'cs-splash';
    }
}

customElements.define(ChameleonSplash.is, ChameleonSplash);
  ...
  */
  ...
  var v = 1,
    ...
    a._applyShimValidatingVersion = a._applyShimNextVersion;a.a || (a.a = !0, ia.then(function () {
      ...
      E;function F(a) {
    E = a && a.shimcssproperties ? !1 : C || !(navigator.userAgent.match("AppleWebKit/601") || !window.CSS || !CSS.supports || !CSS.supports("box-shadow", "0 0 0 var(--foo)"));
    ...
    if (a) {
      ...
      }f === v ? b(a) : c && f === u ? c(a) : f === x && (e = !0);if ((a = a.rules) && !e) for (var e = 0, f = a.length, g; e < f && (g = a[e]); e++) J(g, b, c, d);
    }
  }
  function K(a, b) {
  ...
  function oa(a, b) {
    ...
    for (var c; c = B.exec(b);) {
      var d = c[0],
          ...
          m = [];var l = g.a.get(e);l || (g.a.set(e, {}), l = g.a.get(e));if (l) for (d in g.c && (l.i[g.c] = !0), l.h) g = h && h[d], l = [d, ": var(", e, "_-_", d], g && l.push(",", g), l.push(")"), m.push(l.join(""));d = m.join("; ");b = "" + f + d + b;B.lastIndex = c + d.length;
    }return b;
  }
  function P(a, b) {
  ...
  if (!window.ShadyCSS || !window.ShadyCSS.ScopingShim) {
    var Z = new U(),
        sa = window.ShadyCSS && window.ShadyCSS.CustomStyleInterface;window.ShadyCSS = { prepareTemplate: function (a, b) {
...
const RegisterHtmlTemplate = __webpack_require__(0);
RegisterHtmlTemplate.register("<dom-module id=\"cs-top-navigation\"> <template> <style>:host{display:block}nav{display:flex;height:inherit;flex-direction:row;align-items:stretch;justify-content:flex-start}nav>.nav-link{display:flex;height:inherit;width:20%;margin:.15em .3em;padding:.15em 0;justify-content:center;text-align:center;letter-spacing:2px;font-weight:700;font-family:Tahoma,sans-serif;--bc:var(--nav-link-color, var(--nav-link-default, azure));background-color:var(--bc);color:#fff;font-variant-caps:all-petite-caps;border:1px solid #000}.nav-link span{align-self:center;box-sizing:border-box}.nav-link:nth-of-type(1){--nav-link-color:gold;color:#333}.nav-link:nth-of-type(2){--nav-link-color:rgb(16, 48, 115);color:#eee}.nav-link:nth-of-type(3){--nav-link-color:#BD2031;color:#eee}.nav-link:nth-of-type(4){--nav-link-color:rgb(122, 189, 45);color:#eee}.nav-link:nth-of-type(5){--nav-link-color:orange;color:#333}</style> <nav> <div class=\"nav-link\"> <span>Home Watch</span> </div> <div class=\"nav-link\"> <span>Pressure Washing</span> </div> <div class=\"nav-link\"> <span>Maintenance<br> and Repair</span> </div> <div class=\"nav-link\"> <span>Lawn Care</span> </div> <div class=\"nav-link\"> <span>Other Services</span> </div> </nav> </template> </dom-module> ");

class ChameleonTopNav extends Polymer.Element {
    static get is() {
        return 'cs-top-navigation';
    }

}

customElements.define(ChameleonTopNav.is, ChameleonTopNav);
...
const RegisterHtmlTemplate = __webpack_require__(0);
RegisterHtmlTemplate.register(" <dom-module id=\"cs-banner\"> <template> <style>:host{display:block;min-height:100px;width:inherit;background-color:#faebd7;position:relative;box-shadow:0 4px 5px 0 #333;z-index:-1}#banner-background{display:block;position:absolute;box-sizing:border-box;width:100%;height:100%;padding-top:3em;background:#faebd7 no-repeat center center fixed;background-image:none;background-size:cover;transition:3s}</style> <iron-ajax auto=\"\" url=\"[[imageListPath]]\" handle-as=\"json\" on-response=\"parseBannerImages\" debounce-duration=\"300\"></iron-ajax> <div id=\"banner-background\"></div> </template> </dom-module>");
...
class ChameleonBanner extends Polymer.Element {
    ...
    changeImage() {
        this.currentImage++;
        if (this.currentImage > this.maxImage) this.currentImage = 0;
...
const RegisterHtmlTemplate = __webpack_require__(0);
RegisterHtmlTemplate.register(" <dom-module id=\"cs-schedule\"> <template> Beep beep I'm a sheep </template> </dom-module>");
